      ...
      <form class="bg-white p-5 bg-blur" @submit.prevent="registerUser">
        ...
        <div class="row mb-3 gy-2">
          ...
          <div class="col-md-3">
            ...
            <input type="text" class="form-control" v-model="form.name_extension" />
          </div>
          <div class="col-md-6">
            <label class="form-label">Birthday</label>
            <input type="date" class="form-control" required v-model="form.birth_date" />
          </div>
          <div class="col-md-6">
            ...
            <select class="form-select" v-model="form.sex">
              ...
              <option value="Yes">Yes, once in a week.</option>
            </select>
          </div>
          <div class="col-12">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" required v-model="form.contact_num" />
          </div>
          <div class="col-md-6">
            <label class="form-label">Emergency Contact Number</label>
            <input type="text" class="form-control" required v-model="form.emergency_contact" />
          </div>
          <div class="col-md-6">
            <label class="form-label">Student ID Number</label>
            <input type="text" class="form-control" required v-model="form.student_num" />
          </div>
          <div class="col-md-6">
